<?php $__env->startSection('title', 'Nouvelle Importation de Clients'); ?>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="<?php echo e(route('admin.customer-import.index')); ?>" class="btn btn-secondary">
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('admin.customer-import.upload')); ?>" 
                          method="POST" 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="tenant_id" 
                                                id="tenant_id" 
                                                class="form-select <?php $__errorArgs = ['tenant_id'];
...
unset($__errorArgs, $__bag); ?>" 
                                            ...
                                            <?php $__currentLoopData = $tenants ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tenant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($tenant->id); ?>" 
                                                        ...
                                                        data-database="<?php echo e($tenant->database_name); ?>"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="import_type" 
                                                id="import_type" 
                                                class="form-select <?php $__errorArgs = ['import_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                            ...
                                            <option value="new_customers" <?php echo e(old('import_type') == 'new_customers' ? 'selected' : ''); ?>>
                                                Nouveaux Clients Uniquement
                                            </option>
                                            <option value="update_existing" <?php echo e(old('import_type') == 'update_existing' ? 'selected' : ''); ?>>
                                                Mettre à Jour les Existants
                                            </option>
                                            <option value="mixed" <?php echo e(old('import_type') == 'mixed' ? 'selected' : ''); ?>>
                                                Mixte (Nouveau + Mise à Jour)
                                            </option>
                                        </select>
                                        <?php $__errorArgs = ['import_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="skip_duplicates" id="skip_duplicates" 
                                                   <?php echo e(old('skip_duplicates') ? 'checked' : 'checked'); ?>>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="send_notifications" id="send_notifications" 
                                                   <?php echo e(old('send_notifications') ? 'checked' : ''); ?>>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="validate_emails" id="validate_emails" 
                                                   <?php echo e(old('validate_emails') ? 'checked' : 'checked'); ?>>
                                    ...
                                    <div class="upload-area border-2 border-dashed border-primary rounded p-4 text-center" 
                                        ...
                                        <div class="upload-content">
                                            ...
                                            <input type="file" 
                                                   name="import_file" 
                                                   id="import_file" 
                                                   class="form-control d-none <?php $__errorArgs = ['import_file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                              rows="3" 
                                              placeholder="Ajoutez une description pour cette importation..."><?php echo e(old('description')); ?></textarea>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-2">
                                <div id="debugLogs" style="max-height: 200px; overflow-y: auto; background: #f8f9fa; border: 1px solid #dee2e6; padding: 10px; font-family: monospace; font-size: 12px;">
                                    <div class="text-info">[INFO] Page chargée à <?php echo e(now()->toDateTimeString()); ?></div>
...
$(document).ready(function() {
    ...
    $('#tenant_id').on('change', function() {
        ...
        if (tenantId) {
            ...
            $.ajax({
                url: '<?php echo e(route("admin.customer-import.branches")); ?>',
                method: 'GET',
    ...
    $('#previewBtn').on('click', function() {
        ...
        // Requête AJAX
        $.ajax({
            url: '<?php echo e(route('admin.customer-import.preview')); ?>',
            method: 'POST',
            data: formData,
            processData: false,
            contentType: false,
    ...
    $('#uploadBtn').on('click', function() {
        ...
        $.ajax({
            url: '<?php echo e(route('admin.customer-import.upload')); ?>',
            method: 'POST',
            data: formData,
            processData: false,
            contentType: false,
            ...
            success: function(response) {
                ...
                if (response.import_id) {
                    html += `<div class="mt-3">`;
                    html += `<a href="<?php echo e(route('admin.customer-import.show', '')); ?>/${response.import_id}" class="btn btn-primary btn-sm me-2">`;
                    html += `<i class="fas fa-eye me-1"></i>Voir les détails`;
                    html += `</a>`;
                    html += `<a href="<?php echo e(route('admin.customer-import.index')); ?>" class="btn btn-secondary btn-sm">`;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\CollectToPay\resources\views/admin/customer-import/create.blade.php ENDPATH**/ ?>