...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard Client'); ?> - CollectToPay</title>
...
<body>
        ...
        <div class="sidebar-header">
            ...
            <?php if(session('customer_auth')): ?>
                ...
                <small class="d-block mt-2 opacity-75">
                    <?php echo e($customer['tenant_name'] ?? 'Hôtel'); ?>
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('customer.profile')); ?>" 
                       class="nav-link <?php echo e(request()->routeIs('customer.profile*') ? 'active' : ''); ?>">
                        ...
                        <?php if(session('customer_auth')): ?>
                            ...
                            <?php if($completion < 100): ?>
                                <span class="badge bg-warning ms-auto"><?php echo e($completion); ?>%</span>
                            <?php else: ?>
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('customer.payments')); ?>" 
                       class="nav-link <?php echo e(request()->routeIs('customer.payments') ? 'active' : ''); ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('customer.history')); ?>" 
                       class="nav-link <?php echo e(request()->routeIs('customer.history') ? 'active' : ''); ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('customer.settings')); ?>" 
                       class="nav-link <?php echo e(request()->routeIs('customer.settings') ? 'active' : ''); ?>">
    ...
    <div class="main-content">
        ...
        <nav class="navbar navbar-expand-lg top-navbar">
            <div class="container-fluid">
                ...
                <div class="navbar-brand">
                    <?php echo $__env->yieldContent('page-title', 'Dashboard Client'); ?>
                </div>
                    ...
                    <?php if(session('customer_auth')): ?>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="me-3 text-end d-none d-md-block">
                                <div class="fw-semibold"><?php echo e($customer['name'] ?? 'Client'); ?></div>
                                <small class="text-muted"><?php echo e($customer['email'] ?? ''); ?></small>
                            </div>
                            <div class="dropdown">
                                <button class="btn btn-outline-primary dropdown-toggle" type="button" data-bs-toggle="dropdown">
                                    <i class="fas fa-user-circle me-1"></i>
                                    <span class="d-none d-md-inline"><?php echo e(explode(' ', $customer['name'] ?? 'Client')[0]); ?></span>
                                </button>
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li><h6 class="dropdown-header"><?php echo e($customer['name'] ?? 'Client'); ?></h6></li>
                                    <li><hr class="dropdown-divider"></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('customer.profile')); ?>">
                                        <i class="fas fa-user me-2"></i>Mon Profil
                                    </a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('customer.settings')); ?>">
        ...
        <div class="content-wrapper">
            <!-- Breadcrumb -->
            <?php if(!request()->routeIs('customer.dashboard')): ?>
            <nav aria-label="breadcrumb" class="mb-4">
                <ol class="breadcrumb">
                    ...
                    <?php elseif(request()->routeIs('customer.settings')): ?>
...
<?php /**PATH C:\xampp\htdocs\CollectToPay\resources\views/layouts/customer.blade.php ENDPATH**/ ?>