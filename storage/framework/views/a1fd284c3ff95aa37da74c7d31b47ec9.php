        ...
        <nav aria-label="breadcrumb" class="d-none d-md-block">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item">
                    <a href="<?php echo e(route('hotel.dashboard')); ?>" class="text-decoration-none">
                        <i class="fas fa-home me-1"></i>
                        Tableau de Bord
                    </a>
                </li>
                <?php if(request()->routeIs('hotel.branches*')): ?>
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(route('hotel.branches.index')); ?>" class="text-decoration-none">
                            Gestion des Branches
                        </a>
                    </li>
                    <?php if(request()->routeIs('hotel.branches.create')): ?>
                        <li class="breadcrumb-item active">Ajouter une Branche</li>
                    <?php elseif(request()->routeIs('hotel.branches.edit')): ?>
                        <li class="breadcrumb-item active">Modifier une Branche</li>
                    <?php elseif(request()->routeIs('hotel.branches.show')): ?>
                        <li class="breadcrumb-item active">Détails de la Branche</li>
                    <?php elseif(request()->routeIs('hotel.branches.settings')): ?>
                        <li class="breadcrumb-item active">Paramètres des Branches</li>
                    <?php else: ?>
                        <li class="breadcrumb-item active">Liste des Branches</li>
                    <?php endif; ?>
                <?php elseif(request()->routeIs('hotel.customer*')): ?>
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(route('hotel.customers.index')); ?>" class="text-decoration-none">
                            Gestion des Clients
                        </a>
                    </li>
                    <?php if(request()->routeIs('hotel.customers.create')): ?>
                        <li class="breadcrumb-item active">Ajouter un Client</li>
                    <?php elseif(request()->routeIs('hotel.customers.edit')): ?>
                        <li class="breadcrumb-item active">Modifier un Client</li>
                    <?php elseif(request()->routeIs('hotel.customers.show')): ?>
                        <li class="breadcrumb-item active">Détails du Client</li>
                    <?php elseif(request()->routeIs('hotel.customer-import.create')): ?>
                        <li class="breadcrumb-item active">Importer des Clients</li>
                    <?php elseif(request()->routeIs('hotel.customer-import.preview')): ?>
                        <li class="breadcrumb-item active">Aperçu de l'Importation</li>
                    <?php elseif(request()->routeIs('hotel.customer-import.show')): ?>
                        <li class="breadcrumb-item active">Détails de l'Importation</li>
                    <?php elseif(request()->routeIs('hotel.customer-import.index')): ?>
                        <li class="breadcrumb-item active">Liste des Importations</li>
                    <?php else: ?>
                        <li class="breadcrumb-item active">Liste des Clients</li>
                    <?php endif; ?>
                <?php elseif(request()->routeIs('hotel.staff*')): ?>
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(route('hotel.staff.index')); ?>" class="text-decoration-none">
                            Gestion du Personnel
                        </a>
                    </li>
                    <?php if(request()->routeIs('hotel.staff.create')): ?>
                        <li class="breadcrumb-item active">Ajouter un Employé</li>
                    <?php elseif(request()->routeIs('hotel.staff.edit')): ?>
                        <li class="breadcrumb-item active">Modifier un Employé</li>
                    <?php elseif(request()->routeIs('hotel.staff.show')): ?>
                        <li class="breadcrumb-item active">Détails de l'Employé</li>
                    <?php elseif(request()->routeIs('hotel.branch-managers.index')): ?>
                        <li class="breadcrumb-item active">Gestionnaires de Branches</li>
                    <?php else: ?>
                        <li class="breadcrumb-item active">Liste du Personnel</li>
                    <?php endif; ?>
                <?php elseif(request()->routeIs('hotel.bookings*')): ?>
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(route('hotel.bookings.index')); ?>" class="text-decoration-none">
                            Réservations
                        </a>
                    </li>
                    <?php if(request()->routeIs('hotel.bookings.create')): ?>
                        <li class="breadcrumb-item active">Nouvelle Réservation</li>
                    <?php elseif(request()->routeIs('hotel.bookings.edit')): ?>
                        <li class="breadcrumb-item active">Modifier une Réservation</li>
                    <?php elseif(request()->routeIs('hotel.bookings.show')): ?>
                        <li class="breadcrumb-item active">Détails de la Réservation</li>
                    <?php elseif(request()->routeIs('hotel.bookings.pending')): ?>
                        <li class="breadcrumb-item active">Réservations en Attente</li>
                    <?php else: ?>
                        <li class="breadcrumb-item active">Toutes les Réservations</li>
                    <?php endif; ?>
                <?php elseif(request()->routeIs('hotel.reports*')): ?>
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(route('hotel.reports.dashboard')); ?>" class="text-decoration-none">
                            Rapports
                        </a>
                    </li>
                    <?php if(request()->routeIs('hotel.reports.branches')): ?>
                        <li class="breadcrumb-item active">Performance par Branche</li>
                    <?php elseif(request()->routeIs('hotel.reports.customers')): ?>
                        <li class="breadcrumb-item active">Analyse Clientèle</li>
                    <?php elseif(request()->routeIs('hotel.reports.export')): ?>
                        <li class="breadcrumb-item active">Exporter Données</li>
                    <?php else: ?>
                        <li class="breadcrumb-item active">Tableau de Performance</li>
                    <?php endif; ?>
                <?php elseif(request()->routeIs('hotel.settings*')): ?>
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(route('hotel.settings.general')); ?>" class="text-decoration-none">
                            Paramètres
                        </a>
                    </li>
                    <?php if(request()->routeIs('hotel.settings.notifications')): ?>
                        <li class="breadcrumb-item active">Notifications</li>
                    <?php elseif(request()->routeIs('hotel.settings.appearance')): ?>
        ...
        <div class="branch-selector me-3 d-none d-md-block">
            <div class="input-group">
                <select class="form-select border-0 bg-light" id="branchSelector" style="border-radius: 20px;">
                    ...
                    <?php $__currentLoopData = auth()->user()->hotel->branches ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="dropdown">
            <button class="btn btn-link text-dark d-flex align-items-center" type="button" data-bs-toggle="dropdown">
                ...
                <div class="d-none d-md-block text-start">
                    <div class="fw-semibold" style="font-size: 0.9rem;"><?php echo e(auth()->user()->name ?? 'Hotel Manager'); ?></div>
                    <small class="text-muted"><?php echo e(auth()->user()->hotel->name ?? 'Nom de l\'Hôtel'); ?></small>
                </div>
...
<?php /**PATH C:\xampp\htdocs\CollectToPay\resources\views/components/hotel/navbar.blade.php ENDPATH**/ ?>