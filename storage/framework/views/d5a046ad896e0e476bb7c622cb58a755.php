        ...
        <nav aria-label="breadcrumb" class="d-none d-md-block">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item">
                    <a href="<?php echo e(route('branch.dashboard')); ?>" class="text-decoration-none">
                        <i class="fas fa-home me-1"></i>
                        Tableau de Bord
                    </a>
                </li>
                <?php if(request()->routeIs('branch.customer*')): ?>
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(route('branch.customers.index')); ?>" class="text-decoration-none">
                            Gestion des Clients
                        </a>
                    </li>
                    <?php if(request()->routeIs('branch.customers.create')): ?>
                        <li class="breadcrumb-item active">Ajouter un Client</li>
                    <?php elseif(request()->routeIs('branch.customers.edit')): ?>
                        <li class="breadcrumb-item active">Modifier un Client</li>
                    <?php elseif(request()->routeIs('branch.customers.show')): ?>
                        <li class="breadcrumb-item active">Détails du Client</li>
                    <?php elseif(request()->routeIs('branch.customer-import.create')): ?>
                        <li class="breadcrumb-item active">Importer des Clients</li>
                    <?php elseif(request()->routeIs('branch.customer-import.preview')): ?>
                        <li class="breadcrumb-item active">Aperçu de l'Importation</li>
                    <?php elseif(request()->routeIs('branch.customer-import.show')): ?>
                        <li class="breadcrumb-item active">Détails de l'Importation</li>
                    <?php elseif(request()->routeIs('branch.customer-import.index')): ?>
                        <li class="breadcrumb-item active">Liste des Importations</li>
                    <?php else: ?>
                        <li class="breadcrumb-item active">Liste des Clients</li>
                    <?php endif; ?>
                <?php elseif(request()->routeIs('branch.bookings*')): ?>
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(route('branch.bookings.index')); ?>" class="text-decoration-none">
                            Réservations
                        </a>
                    </li>
                    <?php if(request()->routeIs('branch.bookings.create')): ?>
                        <li class="breadcrumb-item active">Nouvelle Réservation</li>
                    <?php elseif(request()->routeIs('branch.bookings.edit')): ?>
                        <li class="breadcrumb-item active">Modifier une Réservation</li>
                    <?php elseif(request()->routeIs('branch.bookings.show')): ?>
                        <li class="breadcrumb-item active">Détails de la Réservation</li>
                    <?php elseif(request()->routeIs('branch.bookings.pending')): ?>
                        <li class="breadcrumb-item active">Réservations en Attente</li>
                    <?php else: ?>
                        <li class="breadcrumb-item active">Toutes les Réservations</li>
                    <?php endif; ?>
                <?php elseif(request()->routeIs('branch.staff*')): ?>
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(route('branch.staff.index')); ?>" class="text-decoration-none">
                            Équipe
                        </a>
                    </li>
                    <?php if(request()->routeIs('branch.staff.schedule')): ?>
                        <li class="breadcrumb-item active">Planning</li>
                    <?php else: ?>
                        <li class="breadcrumb-item active">Liste du Personnel</li>
                    <?php endif; ?>
                <?php elseif(request()->routeIs('branch.services*')): ?>
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(route('branch.services.index')); ?>" class="text-decoration-none">
                            Services
                        </a>
                    </li>
                    <?php if(request()->routeIs('branch.services.bookings')): ?>
                        <li class="breadcrumb-item active">Réservations de Services</li>
                    <?php else: ?>
                        <li class="breadcrumb-item active">Liste des Services</li>
                    <?php endif; ?>
                <?php elseif(request()->routeIs('branch.reports*')): ?>
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(route('branch.reports.dashboard')); ?>" class="text-decoration-none">
                            Rapports
                        </a>
                    </li>
                    <?php if(request()->routeIs('branch.reports.customers')): ?>
                        <li class="breadcrumb-item active">Analyse Clientèle</li>
                    <?php elseif(request()->routeIs('branch.reports.export')): ?>
                        <li class="breadcrumb-item active">Exporter Données</li>
                    <?php else: ?>
                        <li class="breadcrumb-item active">Performance</li>
                    <?php endif; ?>
                <?php elseif(request()->routeIs('branch.settings*')): ?>
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(route('branch.settings.general')); ?>" class="text-decoration-none">
                            Paramètres
                        </a>
                    </li>
                    <?php if(request()->routeIs('branch.settings.notifications')): ?>
        ...
        <div class="dropdown">
            <button class="btn btn-link text-dark d-flex align-items-center" type="button" data-bs-toggle="dropdown">
                ...
                <div class="d-none d-md-block text-start">
                    <div class="fw-semibold" style="font-size: 0.9rem;"><?php echo e(auth()->user()->name ?? 'Branch Manager'); ?></div>
                    <small class="text-muted"><?php echo e(auth()->user()->branch->name ?? 'Nom de la Branche'); ?></small>
                </div>
...
<?php /**PATH C:\xampp\htdocs\CollectToPay\resources\views/components/branch/navbar.blade.php ENDPATH**/ ?>