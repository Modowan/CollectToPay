@extends('layouts.branch_manager')

@section('title', 'Tableau de Bord Branch Manager')
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h2 class="mb-1">{{ auth()->user()->branch->name ?? 'Nom de la Branche' }}</h2>
                            <p class="text-muted mb-0">
                                <i class="fas fa-map-marker-alt me-1"></i> 
                                {{ auth()->user()->branch->address ?? 'Adresse de la branche' }}, 
                                {{ auth()->user()->branch->city ?? 'Ville' }}
                            </p>
                        </div>
                        <div class="ms-auto text-end">
                            <span class="badge bg-success p-2">Actif</span>
                            <p class="text-muted mb-0 mt-1">Hôtel: {{ auth()->user()->branch->hotel->name ?? 'Nom de l\'Hôtel' }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <h4 class="mb-0 fw-bold">{{ rand(40, 120) }}</h4>
                            <small class="text-success">
                                <i class="fas fa-arrow-up me-1"></i> +{{ rand(3, 10) }} cette semaine
                            </small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <h4 class="mb-0 fw-bold">{{ rand(15, 40) }}</h4>
                            <small class="text-success">
                                <i class="fas fa-arrow-up me-1"></i> +{{ rand(1, 5) }} aujourd'hui
                            </small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <h4 class="mb-0 fw-bold">{{ rand(5, 15) }}</h4>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <h4 class="mb-0 fw-bold">{{ rand(3, 12) }}</h4>
                            <small class="text-danger">
                                <i class="fas fa-arrow-up me-1"></i> {{ rand(1, 3) }} en attente
                            </small>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card border-0 bg-light h-100">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <small class="text-muted">{{ rand(20, 50) }} utilisations</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="card border-0 bg-light h-100">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span class="badge bg-success">Disponible</span>
                                        <small class="text-muted">{{ rand(10, 30) }} réservations</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card border-0 bg-light h-100">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <small class="text-muted">{{ rand(5, 15) }} places restantes</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="card border-0 bg-light h-100">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <span class="badge bg-success">Disponible</span>
                                        <small class="text-muted">{{ rand(5, 15) }} demandes</small>
                                    </div>
                                </div>
                            </div>
                        </div>
