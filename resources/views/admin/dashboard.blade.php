...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="text-end">
            <small class="text-muted">Dernière connexion : {{ auth()->user()->last_login_at ?? 'Première connexion' }}</small>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            <a href="{{ route('admin.customer-import.create') }}" class="btn btn-primary btn-lg w-100 h-100 d-flex flex-column align-items-center justify-content-center text-decoration-none">
                        ...
                        <div class="col-lg-3 col-md-6 mb-3">
                            <a href="{{ route('admin.customer-import.index') }}" class="btn btn-outline-primary btn-lg w-100 h-100 d-flex flex-column align-items-center justify-content-center text-decoration-none">
                        ...
                        <!-- Gérer les Hôtels -->
                        <div class="col-lg-3 col-md-6 mb-3">
                            <a href="{{ route('admin.hotels.index') }}" class="btn btn-outline-success btn-lg w-100 h-100 d-flex flex-column align-items-center justify-content-center text-decoration-none">
                        ...
                        <!-- Paramètres -->
                        <div class="col-lg-3 col-md-6 mb-3">
                            <a href="{{ route('admin.settings.general') }}" class="btn btn-outline-secondary btn-lg w-100 h-100 d-flex flex-column align-items-center justify-content-center text-decoration-none">
