...
@section('title', 'Historique des Importations')
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('admin.customer-import.create') }}" class="btn btn-primary btn-lg">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('admin.customer-import.index') }}">
                <div class="row">
                    <div class="col-md-3 mb-3">
                        <label for="search" class="form-label">Recherche</label>
                        <input type="text" class="form-control" id="search" name="search" 
                               placeholder="Nom de fichier, hôtel..." value="{{ request('search') }}">
                    </div>
                    <div class="col-md-3 mb-3">
                        <label for="hotel" class="form-label">Hôtel</label>
                        <select class="form-select" id="hotel" name="hotel">
                            <option value="">Tous les hôtels</option>
                            <option value="hilton" {{ request('hotel') == 'hilton' ? 'selected' : '' }}>Hôtel Hilton Paris</option>
                            <option value="marriott" {{ request('hotel') == 'marriott' ? 'selected' : '' }}>Hôtel Marriott Lyon</option>
                            <option value="accor" {{ request('hotel') == 'accor' ? 'selected' : '' }}>Hôtel Accor Nice</option>
                            <option value="sofitel" {{ request('hotel') == 'sofitel' ? 'selected' : '' }}>Hôtel Sofitel Marseille</option>
                            <option value="ibis" {{ request('hotel') == 'ibis' ? 'selected' : '' }}>Hôtel Ibis Toulouse</option>
                        </select>
                    </div>
                    <div class="col-md-3 mb-3">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <a href="{{ route('admin.customer-import.index') }}" class="btn btn-outline-secondary">
                ...
                <table class="table table-bordered table-hover" id="importsTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <a href="{{ route('admin.customer-import.show', 1) }}" class="btn btn-outline-primary btn-sm" title="Voir les détails">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <a href="{{ route('admin.customer-import.show', 2) }}" class="btn btn-outline-primary btn-sm" title="Voir les détails">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <button class="btn btn-outline-success btn-sm" title="Télécharger le rapport">
                                        <i class="fas fa-download"></i>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <a href="{{ route('admin.customer-import.show', 3) }}" class="btn btn-outline-primary btn-sm" title="Voir les détails">
                                        <i class="fas fa-eye"></i>
                                    </a>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <a href="{{ route('admin.customer-import.show', 4) }}" class="btn btn-outline-primary btn-sm" title="Voir les détails">
                                        <i class="fas fa-eye"></i>
                                    </a>
