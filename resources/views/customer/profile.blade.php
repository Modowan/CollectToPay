                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select form-select-lg" id="gender" name="gender">
                            ...
                            <option value="male" {{ old('gender', $customer->gender ?? '') == 'male' ? 'selected' : '' }}>Homme</option>
                            <option value="female" {{ old('gender', $customer->gender ?? '') == 'female' ? 'selected' : '' }}>Femme</option>
                            <option value="other" {{ old('gender', $customer->gender ?? '') == 'other' ? 'selected' : '' }}>Autre</option>
                        </select>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select form-select-lg" id="country" name="country" required>
                            ...
                            <option value="Belgique" {{ old('country', $customer->country ?? '') == 'Belgique' ? 'selected' : '' }}>Belgique</option>
                            <option value="Suisse" {{ old('country', $customer->country ?? '') == 'Suisse' ? 'selected' : '' }}>Suisse</option>
                            <option value="Canada" {{ old('country', $customer->country ?? '') == 'Canada' ? 'selected' : '' }}>Canada</option>
                            <option value="Maroc" {{ old('country', $customer->country ?? '') == 'Maroc' ? 'selected' : '' }}>Maroc</option>
                            <option value="Algérie" {{ old('country', $customer->country ?? '') == 'Algérie' ? 'selected' : '' }}>Algérie</option>
                            <option value="Tunisie" {{ old('country', $customer->country ?? '') == 'Tunisie' ? 'selected' : '' }}>Tunisie</option>
                            <option value="Autre" {{ old('country', $customer->country ?? '') == 'Autre' ? 'selected' : '' }}>Autre</option>
                        </select>
                        <div class="invalid-feedback"></div>
                    </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select form-select-lg" id="emergency_contact_relation" name="emergency_contact_relation">
                            <option value="">Sélectionner...</option>
                            <option value="Conjoint(e)" {{ old('emergency_contact_relation', $customer->emergency_contact_relation ?? '') == 'Conjoint(e)' ? 'selected' : '' }}>Conjoint(e)</option>
                            <option value="Parent" {{ old('emergency_contact_relation', $customer->emergency_contact_relation ?? '') == 'Parent' ? 'selected' : '' }}>Parent</option>
                            <option value="Enfant" {{ old('emergency_contact_relation', $customer->emergency_contact_relation ?? '') == 'Enfant' ? 'selected' : '' }}>Enfant</option>
                            <option value="Frère/Sœur" {{ old('emergency_contact_relation', $customer->emergency_contact_relation ?? '') == 'Frère/Sœur' ? 'selected' : '' }}>Frère/Sœur</option>
                            <option value="Ami(e)" {{ old('emergency_contact_relation', $customer->emergency_contact_relation ?? '') == 'Ami(e)' ? 'selected' : '' }}>Ami(e)</option>
                            <option value="Collègue" {{ old('emergency_contact_relation', $customer->emergency_contact_relation ?? '') == 'Collègue' ? 'selected' : '' }}>Collègue</option>
                            <option value="Autre" {{ old('emergency_contact_relation', $customer->emergency_contact_relation ?? '') == 'Autre' ? 'selected' : '' }}>Autre</option>
                        </select>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="accept_tokenisation" name="accept_tokenisation" value="1" 
                                   {{ (old('accept_tokenisation', $customer->accept_tokenisation ?? false)) ? 'checked' : '' }}>
            ...
            <div class="card-body p-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="pref_email" name="preferences[communication_email]" value="1" 
                                       {{ (old('preferences.communication_email', $preferences['communication_email'] ?? false)) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-4">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="pref_sms" name="preferences[communication_sms]" value="1"
                                       {{ (old('preferences.communication_sms', $preferences['communication_sms'] ?? false)) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-4">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="pref_phone" name="preferences[communication_phone]" value="1"
                                       {{ (old('preferences.communication_phone', $preferences['communication_phone'] ?? false)) ? 'checked' : '' }}>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="room_preference" name="preferences[room_preference]">
                                ...
                                <option value="quiet" {{ old('preferences.room_preference', $preferences['room_preference'] ?? '') == 'quiet' ? 'selected' : '' }}>Chambre calme</option>
                                <option value="view" {{ old('preferences.room_preference', $preferences['room_preference'] ?? '') == 'view' ? 'selected' : '' }}>Avec vue</option>
                                <option value="high_floor" {{ old('preferences.room_preference', $preferences['room_preference'] ?? '') == 'high_floor' ? 'selected' : '' }}>Étage élevé</option>
                                <option value="ground_floor" {{ old('preferences.room_preference', $preferences['room_preference'] ?? '') == 'ground_floor' ? 'selected' : '' }}>Rez-de-chaussée</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="special_diet" name="preferences[special_diet]">
                                ...
                                <option value="vegetarian" {{ old('preferences.special_diet', $preferences['special_diet'] ?? '') == 'vegetarian' ? 'selected' : '' }}>Végétarien</option>
                                <option value="vegan" {{ old('preferences.special_diet', $preferences['special_diet'] ?? '') == 'vegan' ? 'selected' : '' }}>Végétalien</option>
                                <option value="halal" {{ old('preferences.special_diet', $preferences['special_diet'] ?? '') == 'halal' ? 'selected' : '' }}>Halal</option>
                                <option value="kosher" {{ old('preferences.special_diet', $preferences['special_diet'] ?? '') == 'kosher' ? 'selected' : '' }}>Casher</option>
                                <option value="gluten_free" {{ old('preferences.special_diet', $preferences['special_diet'] ?? '') == 'gluten_free' ? 'selected' : '' }}>Sans gluten</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" 
                              ...
                              rows="3" 
                              maxlength="1000"
                              placeholder="Décrivez vos demandes spéciales ou besoins particuliers...">{{ old('special_requests', $customer->special_requests ?? '') }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" 
                              ...
                              rows="2" 
                              maxlength="500"
                              placeholder="Informations complémentaires...">{{ old('notes', $customer->notes ?? '') }}</textarea>
