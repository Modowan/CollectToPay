                        ...
                        <div class="col-md-8">
                            @if(session('customer_auth'))
                                ...
                                <h1 class="h3 mb-2">
                                    ...
                                    Bonjour {{ explode(' ', $customer['name'] ?? 'Client')[0] }} !
                                </h1>
                                <p class="mb-0 opacity-90">
                                    Bienvenue dans votre espace client {{ $customer['tenant_name'] ?? 'Hôtel' }}
                                </p>
                            @else
                                <h1 class="h3 mb-2">
                                    <i class="fas fa-sun me-2"></i>
            ...
            <div class="col-12">
                <div class="alert alert-warning border-0 shadow-sm" role="alert">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4 text-end">
                            <a href="{{ route('customer.profile') }}" class="btn btn-warning">
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="card border-0 shadow-sm h-100 hover-card">
                <div class="card-body text-center p-4">
                    ...
                    @if(session('customer_auth'))
                        @php $completionPercentage = 45; @endphp
                        <div class="mb-3">
                            ...
                            <small class="text-muted">{{ $completionPercentage }}% complété</small>
                        </div>
                    @endif
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="card border-0 shadow-sm h-100 hover-card">
                <div class="card-body text-center p-4">
                    ...
                    <a href="{{ route('customer.payments') }}" class="btn btn-success">
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="card border-0 shadow-sm h-100 hover-card">
                <div class="card-body text-center p-4">
                    ...
                    <a href="{{ route('customer.history') }}" class="btn btn-info">
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body text-center">
                    @if(session('customer_auth'))
                        ...
                        <h6 class="mb-2">Profil {{ $completionPercentage < 100 ? 'incomplet' : 'complet' }}</h6>
                        <p class="text-muted small mb-3">
                            {{ $completionPercentage < 100 ? 'Complétez votre profil pour une meilleure expérience' : 'Votre profil est complet !' }}
                        </p>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-bottom-0 py-3">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <a href="{{ route('customer.history') }}" class="btn btn-outline-primary btn-sm">
                                Voir tout
                            </a>
                        </div>
                    </div>
