@extends('layouts.hotel_manager')

@section('title', 'Tableau de Bord Hotel Manager')
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h2 class="mb-1">{{ auth()->user()->hotel->name ?? 'Nom de l\'Hôtel' }}</h2>
                            <p class="text-muted mb-0">
                                <i class="fas fa-map-marker-alt me-1"></i> 
                                {{ auth()->user()->hotel->address ?? 'Adresse de l\'hôtel' }}, 
                                {{ auth()->user()->hotel->city ?? 'Ville' }}
                            </p>
                        </div>
                        <div class="ms-auto text-end">
                            <span class="badge bg-success p-2">Actif</span>
                            <p class="text-muted mb-0 mt-1">ID: {{ auth()->user()->hotel->id ?? '1' }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <h4 class="mb-0 fw-bold">{{ rand(3, 8) }}</h4>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <h4 class="mb-0 fw-bold">{{ rand(120, 350) }}</h4>
                            <small class="text-success">
                                <i class="fas fa-arrow-up me-1"></i> +{{ rand(5, 20) }} cette semaine
                            </small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <h4 class="mb-0 fw-bold">{{ rand(30, 80) }}</h4>
                            <small class="text-success">
                                <i class="fas fa-arrow-up me-1"></i> +{{ rand(3, 12) }} aujourd'hui
                            </small>
                        </div>
                    </div>
                </div>
            ...
            <div class="card border-0 shadow-sm h-100">
                <div class="card-header bg-transparent border-0 pt-4 pb-2">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <a href="{{ route('hotel.branches.index') }}" class="btn btn-sm btn-primary">
