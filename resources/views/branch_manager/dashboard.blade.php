...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">{{ __('Tableau de bord Gestionnaire de Filiale') }}</div>
                ...
                <div class="card-body">
                    ...
                    <p>
                        ...
                        @elseif(Auth::guard('tenant')->check())
                            Vous êtes connecté en tant que {{ Auth::guard('tenant')->user()->name }}.
                        @elseif(session('user_name'))
                            Vous êtes connecté en tant que {{ session('user_name') }}.
                        @else
